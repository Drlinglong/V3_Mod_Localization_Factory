...
def initialize_client(api_key: str = None) -> "OpenAI | None":
    ...
    try:
        ...
        logging.info(f"OpenAI client initialized successfully, using model: {model_name}")
        return client
    except Exception as e:
        logging.exception(f"Error initializing OpenAI client: {e}")
        return None
...
#         # This entire function is likely deprecated and replaced by the ParallelProcessor flow.
